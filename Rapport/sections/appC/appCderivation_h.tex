...
In \trine{Dette er udledning af båndstop, skal laves om til bandpass!!!}order to derive the ideal impulse response the ideal frequency response is defined as follows on behave of figure \ref{fig i FIR spec}\trine{husk ref}.
\begin{align*}
