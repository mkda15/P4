...
\draw[line width=0.3mm](axis cs:0,0)--(axis cs:1.5,0);
\draw[line width=0.3mm](axis cs:1.5,1.5)--(axis cs:3,1.5);
\draw[line width=0.3mm](axis cs:1.5,1.5)--(axis cs:1.5,0);
\end{axis}
\end{tikzpicture}
...
ymax=2.6]
\node at (axis cs:0.8,2.4) {$|H(\omega)|$};
\draw[line width=0.3mm](axis cs:1,1.5)--(axis cs:1,0);
\draw[line width=0.3mm](axis cs:1,1.5)--(axis cs:2,1.5);
\draw[line width=0.3mm](axis cs:2,1.5)--(axis cs:2,0);
\draw[line width=0.3mm](axis cs:1,0)--(axis cs:0,0);
\draw[line width=0.3mm](axis cs:2,0)--(axis cs:3,0);
\end{axis}
\end{tikzpicture}
\caption{}
    \end{subfigure}
...
\martin{Ret figur. \textregistered}
