...
\draw[line width=0.3mm, dashed](axis cs:0,3.7)--(axis cs:2,3.7);
\draw[line width=0.3mm, dashed](axis cs:0,3)--(axis cs:2,3);
\draw[line width=0.3mm](axis cs:2,3)--(axis cs:2,0);
\draw[line width=0.3mm](axis cs:4,3.7)--(axis cs:4,0.5);
\draw[line width=0.3mm, dashed](axis cs:4,0.5)--(axis cs:7,0.5);

\node at (axis cs:3,1.5) {$\Delta\omega$};
\addplot [->,>={}] coordinates {( 2.5,1.5)(2,1.5)};
