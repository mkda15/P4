...
\begin{enumerate}[label=(\alph*)]
\item
By definitions \ref{def:Fourier_trans}, \ref{def:InverseFourier_trans} and \ref{def:TMD} it follows that:\frede{Tjek det her}
\begin{align*}
...
\begin{align*}
\mathcal{F}\{\phi_i(t)\}(\omega) = 2 \text{e}^{-jt_i\omega} \frac{\sin(a_i\omega)}{\omega},
\end{align*}
