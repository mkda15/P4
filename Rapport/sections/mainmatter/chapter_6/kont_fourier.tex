...
&= \int_{-\infty}^\infty \int_{-\infty}^\infty \text{e}^{-j\omega z} f(z) \text{e}^{-j\omega \tau} g(\tau) dz d\tau \\
...
\martin{Mangler i dette afsnit: der skal ryddes lidt op i dette afsnit, da nogle af sætningerne sandsynligvis hører til under afsnittet om Fourier-rækker.}