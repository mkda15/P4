This project deals with functions and sequences in the so-called $\mathcal{L}^p$ and $\ell^p$ spaces, respectively. The following definitions are inspired by \cite{chapter 5-6, FSE2010} and \cite{chapter 2, FSP} \martin{Forslag: udbyg dette kapitel til at indeholde det matematiske fundament vedrørende begreber såsom Banach-rum, Hilbert-rum, definitioner af kravene for disse og desuden definitionen af de lineære operatorer nederst i kapitel 4. \textregistered}.

\begin{definition}[The $\mathcal{L}^p$ spaces]
