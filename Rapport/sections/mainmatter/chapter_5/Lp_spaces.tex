This project deals with functions and sequences in the so-called $\mathcal{L}^p$ and $\ell^p$ spaces, respectively. The following definitions are inspired by \cite{chapter 5-6, FSE2010} and \cite{chapter 2, FSP} \martin{Overvej alternativ. Hvad bruger vi af definition 5.0.5? \textregistered}.
