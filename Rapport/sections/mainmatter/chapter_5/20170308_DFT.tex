...
%There is an equivalence between multiplying Fourier transforms of sequences, and colving them.
...
%\begin{align*}
%	(Hx)_n) = (h \ast x)_n = \sum_{k \in \mathbb{Z}} x_k h_{n-k} =\sum_{k \in \mathbb{Z}} x_{n-k} h_k
%\end{align*}
% \end{definition}
%221 \chr{Kan bruges til at vise ovenstående påstand om eigensekvenser for LSI systemer}
