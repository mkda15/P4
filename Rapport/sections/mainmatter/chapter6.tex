...
An analogue-to-digital converter (ADC) is a device which as the name suggests is capable of converting an analogue signal to a digital signal in a way close to the aforementioned mathematically described way. The analogue signal is in the case of this project voltage from a microphone reacting to sound waves. This section will establish the basic concepts of an ADC, but not explain the in-depth theory, as the ADC is merely a tool and not a focus point of this project. An audio ADC consists of the following elements:
\begin{enumerate}
