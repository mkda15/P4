...
\textit{Aliasing} is a consequence of not sampling  at a sufficiently high $f_s$ which results in the continous signal being non reconstructable from the sampled data.
\\\\
A signal is \textit{bandlimited} if there is an upper and a lower bound of frequencies in the signal. The upper bound is called $\omega_N$ and the difference between the lower and upper bound is called the \textit{badnwidth}. To avoid aliasing, the bandwidth (more specifically $\omega_N$) must be taken into account. The below analyzis shows this.
\\\\
...
\draw[line width=0.5mm](axis cs:0.66,1.01)--(axis cs:1.33,1,01);
\draw[line width=0.5mm](axis cs:2,2)--(axis cs:2.66,1,01);
\draw[line width=0.5mm](axis cs:2.66,1,01)--(axis cs:3.33,1.01);
\draw[line width=0.5mm](axis cs:3.33,1.01)--(axis cs:4,2);
\draw[line width=0.5mm](axis cs:4,2)--(axis cs:4.66,1.01);
\draw[line width=0.5mm](axis cs:0,2)--(axis cs:-0.66,1.01);
\draw[line width=0.5mm](axis cs:-2,2)--(axis cs:-1.33,1.01);
\draw[line width=0.5mm](axis cs:-0.66,1.01)--(axis cs:-1.33,1,01);
\draw[line width=0.5mm](axis cs:-2,2)--(axis cs:-2.66,1,01);
...
\draw[line width=0.5mm](axis cs:-3.33,1.01)--(axis cs:-4,2);
\draw[line width=0.5mm](axis cs:-4,2)--(axis cs:-4.66,1.01);
\draw[line width=0.5mm](axis cs:-4.66,1.01)--(axis cs:-5.33,1.01);
\draw[line width=0.5mm](axis cs:4.66,1.01)--(axis cs:5.33,1.01);
\end{axis}
\end{tikzpicture}
