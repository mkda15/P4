...
The resistance towards varying noise will be investigated in the following chapter.           \trine{skal vi tilføje diskussion om forbedringer? restrektion på filter i forhold til at vi til passer?}