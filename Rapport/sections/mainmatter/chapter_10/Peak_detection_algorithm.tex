...
The algorithm is tested as stated in \ref{ch3} \chr{Bør nok være section 3.3 med unit test og ikke kun kapitel 3} by feeding  a STFT of a noise filled audio fill containing an "$E_2$" tone being played on a guitar. 
