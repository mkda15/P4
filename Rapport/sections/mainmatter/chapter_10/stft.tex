...
\State $overlap=2$ \Comment{Number of overlaps of every FFT - 2 is 50\%}
...
\end{figure}
The above figures together with figures *Insert reference* in chapter *Insert reference* with plots of the dB amplitude of the windows are used to determine which window is optimal for the purpose of this project in conjunction with the paper of *Insert name of author*. It is assessed that the window most useful for the purpose of the STFT in this project is the Kaiser window, which is the favourite of the source and the bestperforming in the creatioj of spectrograms. This window will be used in the STFT from now on.
