...
\caption{Spectrogram of octatonic scale played on a guitar, plucking only one string at a time. plot af skala laves om så man kan se skalaen \smiley}
