...
sig(x)=\begin{cases}\sin(1000\pi x)&\text{for }0\leq n<25\\
\sin(3000\pi x)&\text{for }25\leq x < 50\\
\sin(3000\pi x)+\sin(3250\pi x)&\text{for }50\leq n\leq75
\end{cases}
\end{align}
