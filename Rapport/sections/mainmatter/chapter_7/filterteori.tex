...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.6\textwidth]{figures/FIR1.png}
    \caption{Process of convolution  a) Desired frequency response $H_d(e^{j\omega})$ and Fourier tranform of window $W(e^{j\omega})$. b) Typical approximation of $H(e^{j\omega})$ resulting from the convolution. }
    \label{fig:FIR1}
\end{figure} 
