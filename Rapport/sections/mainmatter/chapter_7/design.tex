...
The Butterworth filter is used as a design method to fit the filter to the requirements and is a lowpass filter approximation. For the Butterworth filter the squared magnitude is defined as follows.
