...
On behave of the stated specifications to the system figure \ref{fig:system} illustrates the final system which will form a basis of the further work. Main focus of the project is the development of the algorithm in the application ..\trine{skal der være noget sån ala det sidste her?}}   
\begin{figure}[H]
\centering
