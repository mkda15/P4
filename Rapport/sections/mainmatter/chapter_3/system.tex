...
The main part of the system is the algorithm that will provide as an application which take an audio file as input and generate the corresponding note sheet. As described i chapter \ref{ch2} a note sheet is basically a spectrogram showing the frequency of the tones. By this the main purpose is to identify the frequencies on the audio file.      
