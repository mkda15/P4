...
The algorithm inside the application is delimited to create a spectrogram illustrating the frequencies corresponding to the tones on the audio file with a corresponding illustration of the most signinficant frequencies in the signal. The noise is expected to be reduced in such degree that it is possible to identify the significant frequencies by the spectrogram, which will form the output of the system. \trine{"Jeg fikser figurerne" - \smiley}
\begin{figure}[H]
\centering
\hspace*{-2cm}
