...
\begin{itemize}
\item[] \textbf{Signal modification} is needed in this project to select which frequencies are wanted for the spectral analysis and remove unwanted frequencies. The modification is done by a digital filter designed to reduce noise in the signal - because noise is expected in a recorded sound signal. Such filter is linear and time invariant.\trine{skal/behøves LTI at nævnes her?} The choice of filter type and definition of desired specifications will be made on behalf of a frequency analysis of recorded music and noise signals that could be representative for the use of the system.             
