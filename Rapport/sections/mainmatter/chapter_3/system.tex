...
To develop and design the application a synthesis approach is used to expand the basic concept of the application in order to define the purpose and thereby requirements for each part of the application.
