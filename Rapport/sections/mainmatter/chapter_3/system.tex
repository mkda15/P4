...
The filter will be linear and time invariant, thus the filter will be designed to a specific audio file. The filter is expected to remove simple noise that could occur in a recording situation. \trine{specify the type of filter and noise later}             
\\ 
...
The input of the system are delimited to be an audio file recorded in an anechoic chamber containing a single tone including a known noise. \\
