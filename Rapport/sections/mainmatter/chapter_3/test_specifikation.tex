...
Units in the model are as follows:
\begin{multicols}{2}
...
When this is achived it is of further interest to test the system on a single chord in order to find the limitations of the system.\trine{nyt, nyt}  
\\
