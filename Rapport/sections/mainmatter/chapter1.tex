...
\chr{En meget creative process (Står en del gange). Man kan godt ændre det til ``process'' nogle af gangene.}
...
The end product of this project is limited to an algorithm based on mathematical tools which is capable of transcribing a prerecorded piece of simple music to a spectrogram. The system model is fully established in chapter \ref{ch3}. \trine{har forsøgt at tilføje underspørgsmål og kort afgrænsning, er det noget vi vil have med alligevel?}       
