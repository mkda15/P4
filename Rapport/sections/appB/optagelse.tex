...
Table \ref{tab:equip} specifies the equipment used for the recording. Figures \ref{fig:setup1} and \ref{fig:setup2} show the set up inside the anechoic room \martin{$2x2$ i tabellen? \textregistered}.   
\begin{table}[H]
\centering
