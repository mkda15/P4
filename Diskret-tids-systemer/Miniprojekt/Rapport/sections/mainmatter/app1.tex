...
\centering
\includegraphics[width=\textwidth]{figures/Filter/Filter_Hamming_64.png}
\end{minipage}
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/Filter/Filter_Hamming_128.png}
\end{minipage}
\caption{Amplituderesponser for filteret af orden $M = 64$ og $M=128$ ved anvendelse af Hamming-vinduet.}
